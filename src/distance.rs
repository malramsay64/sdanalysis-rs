...
mod tests {
    ...
    proptest! {
        #[test]
        fn within_cell_round(x in 0_f32..1_f32, y in 0_f32..1_f32, z in 0_f32..1_f32) {
            let cell = [1., 1., 1., 0., 0., 0.];
            let point = make_cartesian(&cell, &[x, y, z]);
            assert_eq!(min_image_round(&cell, &point), point);
        }
    }
